...
use jamx\Http\Requests\DouyasiRequest;
...
class UserRequest extends Request
{
    ...
    public function rules($type = 'store')
    {
        ...
        //store
            ...
            $rules = [
                'username'                 => 'required|min:4|max:10|eng_alpha_num|unique:saas_users,username',
                ...
                'realname'                 => 'required|min:2|max:5|regex:/^[\x{4e00}-\x{9fa5}]{2,5}$/u',  //中文正则匹配可能有遗漏
                'phone'                    => 'size:11|mobile_phone|unique:saas_users,phone',
            ];
        }
        return $rules;
    }
