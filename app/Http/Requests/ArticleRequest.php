...
namespace jamx\Http\Requests;

use jamx\Http\Requests\Request;
...
class ArticleRequest extends Request
{
    ...
    public function rules()
    {
        $rules = [
            ...
            //'category_id' => 'required|exists:saas_metas,id,type,CATEGORY',
        ...
        if($this->segment(3)){
            ...
            $rules = array_add($rules, 'slug', 'required|max:30|eng_alpha_dash|unique:saas_contents,slug'.$id);
        }
