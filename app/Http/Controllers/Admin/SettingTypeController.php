...
use jamx\Http\Requests\SettingTypeRequest;
 ...
 */
class SettingTypeController extends BackController
{
...
/**
     ...
     * @return Response
     */
    public function storec(SettingTypeRequest $request)
    {
        $this->do_store($request);
    }
     ...
     * @return Response
     */
    public function updatec(SettingTypeRequest $request, $id)
    {
        $data = $request->all();
