...
use jamx\Repositories\ContentRepository;  //模型仓库层
use jamx\Repositories\FlagRepository;  //推荐位仓库层
...
class AdminArticleController extends BackController
{
     ...
     *
     * @var jamx\Repositories\ContentRepository
     */
    protected $content;
     ...
     *
     * @var jamx\Repositories\FlagRepository
     */
    protected $flag;
     ...
     *
     * @param \jamx\Http\Requests\ArticleRequest $request
     * @param  int  $id
     * @return Response
     */
