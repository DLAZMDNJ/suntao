 ...
 */
class Group extends Mis implements AuthenticatableContract, CanResetPasswordContract
{
    ...
    //protected $fillable = [ 'name', 'last_channel', 'textture', 'last_active', 'nick', 'state', '3346_id', 'created_gid', 'ctime', 'description','is_delete','default_channel'];
    protected $hidden = [''];
    ...
    public function roles() {
    	return $this->belongsTo('jamx\Models\Role','role_id','id');
    }*/
