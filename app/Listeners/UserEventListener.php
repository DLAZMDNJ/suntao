...
//         SystemLogger::write($log);
    ...
    public function subscribe($events)
    {
        ...
        $events->listen('jamx\Events\UserLogin', 'jamx\Listeners\UserEventListener@onUserLogin');
        $events->listen('jamx\Events\UserLogout', 'jamx\Listeners\UserEventListener@onUserLogout');
        $events->listen('jamx\Events\UserUpdate', 'jamx\Listeners\UserEventListener@onUserUpdate');
        $events->listen('jamx\Events\UserUpload', 'jamx\Listeners\UserEventListener@onUserUpload');
    }
}
