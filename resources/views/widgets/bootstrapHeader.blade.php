    ...
    <div class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                <a href="/" class="navbar-brand">{{ Cache::get('website_title','') }}</a>
            ...
            <div class="navbar-collapse collapse" id="navbar-main" aria-expanded="true" style="">
                <ul class="nav navbar-nav">
                    ...
                    @inject('article_service', 'Saas\Services\ArticleService') {{-- Blade模版里面服务注入 Laravel 5.1 LTS 新增功能 --}}
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="download">
                            <li><a href="https://github.com/douyasi/ppsaas">源码</a></li>
                            <li class="divider"></li>
                            <li><a href="http://www.jinsec.com/docs">手册</a></li>
                        </ul>
                    </li>
                </ul>
